package lesson2.labsolns.prob2Cvar;
...
public class Student {
	...
	void addSectionWeak(String course, int sectionNum) {
		studentSections.add(new StudentSection(this, new Section(course, sectionNum)));
	}
